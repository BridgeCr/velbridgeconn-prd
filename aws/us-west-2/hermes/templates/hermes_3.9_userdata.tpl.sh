...
## DSO-1273
## (https://bridgeconnector.atlassian.net/browse/DSO-1273)
...
yum -y install cifs-utils python3-pip amazon-ssm-agent
pip3 install awscli
...
%{ if licensed ~}
license.key = b46292a44e95447888e0b878c713037c-c3065aa140da7c56e5d2cb9cce4ee1af-83189754328780c24d834d7996500615-6a025ba1eb0c73ed21fbf3bb35a18cv2
%{ endif ~}
EOF
...
/usr/local/bin/aws s3 sync --sse aws:kms s3://hermes-enterprise/3.9/custom-extensions /opt/connect/custom-extensions
